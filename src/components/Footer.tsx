...
function Footer() {
  ...
  return (
    <footer className="relative z-10 mx-auto w-full max-w-300 px-6 pb-[calc(2rem+env(safe-area-inset-bottom))] md:px-10 md:pb-[calc(3rem+env(safe-area-inset-bottom))] lg:px-16">

      ...
      <div className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-surface/80 p-1.5 shadow-2xl backdrop-blur-md select-none">
        ...
        >
          <InteractiveGlass
            ...
            className="notranslate flex h-11 w-16 items-center justify-center text-sm font-bold tracking-wider text-text-primary uppercase transition-opacity select-none disabled:pointer-events-none disabled:cursor-default disabled:opacity-40"
            onClick={() => {

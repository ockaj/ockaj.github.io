...
export const ProcessLibrary = lazy(
  () => import("./components/ProcessLibrary/ProcessLibrary.tsx"),
);
...
export const loadPdfViewerModal = () =>
  import("./components/PdfViewerModal/PdfViewerModal.tsx");
export const PdfViewerModal = lazy(loadPdfViewerModal);
export const BpmnOverlay = lazy(
  () => import("./components/Bpmn/BpmnOverlay.tsx"),
);
